...
# Función para mostrar el desarrollo matemático
def show_math_development():
    
     # Crear una nueva figura para mostrar el desarrollo matemático
     fig_math =plt.figure(figsize=(12,10))
     
     # Títulos y descripciones para cada tipo de modulación
     ax1= fig_math.add_subplot(311) 
     ax1.text(0.5,0.8,'Modulación AM', fontsize=16,horizontalalignment='center', verticalalignment='center', weight='bold')
     ax1.text(0.5,0.5,'$X_{AM}(t) = A_c (1 + m(t)) \cos(2\pi f_c t)$', fontsize=14,horizontalalignment='center', verticalalignment='center')
     ax1.text(0.5,0.3,'Donde:\nA_c: Amplitud de la portadora\nm(t): Señal del mensaje\nf_c: Frecuencia de la portadora', fontsize=12,horizontalalignment='center', verticalalignment='center')
     ax1.axis('off') 

     ax2= fig_math.add_subplot(312) 
     ax2.text(0.5,0.8,'Modulación FM', fontsize=16,horizontalalignment='center', verticalalignment='center', weight='bold')
     ax2.text(0.5,0.5,'$X_{FM}(t) = A_c \cos\left(2\pi f_c t + k_f \int_{-\infty}^t m(\tau) d\tau\right)$', fontsize=14,horizontalalignment='center', verticalalignment='center')
     ax2.text(0.5,0.3,'Donde:\nk_f: Índice de modulación\nm(t): Señal del mensaje\nf_c: Frecuencia de la portadora', fontsize=12,horizontalalignment='center', verticalalignment='center')
     ax2.axis('off') 

     ax3= fig_math.add_subplot(313) 
     ax3.text(0.5,0.8,'Modulación PM', fontsize=16,horizontalalignment='center', verticalalignment='center', weight='bold')
     ax3.text(0.5,0.5,'$X_{PM}(t) = A_c \cos\left(2\pi f_c t + k_p \int_{-\infty}^t m(\tau) d\tau\right)$', fontsize=14,horizontalalignment='center', verticalalignment='center')
     ax3.text(0.5,0.3,'Donde:\nk_p: Índice de modulación\nm(t): Señal del mensaje\nf_c: Frecuencia de la portadora', fontsize=12,horizontalalignment='center', verticalalignment='center')
     ax3.axis('off') 

     # Mostrar figura con desarrollo matemático
     plt.tight_layout()
     plt.show(block=True)  # Mantener la figura abierta
...
# Mostrar el desarrollo matemático para cada tipo de modulación.
show_math_development()
